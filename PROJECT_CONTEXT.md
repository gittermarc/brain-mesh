...
- `BrainMesh/GraphChat/`
  ...
  - `UI/` enthält die interne, dependency-injizierte SwiftUI-Präsentationsschicht mit Main-Actor-ViewModel, Composer, Availability-/Indexstatus, deterministischer Stream-Reduktion, navigation-agnostischen Evidence-Karten und ausschließlich flüchtigem graph-/scope-getrenntem Verlauf. Ein produktiver Einstieg ist bewusst noch nicht registriert.
