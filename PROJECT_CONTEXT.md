...
> Start Here für neue Entwickler:innen. Stand: INTENT-COMPILER-2 mit zweistufigem semantischem Intent-Interpreter, versionierter Typed-Intent-Domain und gemeinsamem providerfreiem Execution Kernel.
...
- **Semantic Intent Interpreter**: Nachgelagerte On-Device-Foundation-Models-Stufe für freie Find-Nodes- und Entity-List-Formulierungen. Das Modell erhält weder Tools noch technische Identitäten und erzeugt nur einen begrenzten, untrusted und value-only Draft. Erst Validator und Resolver der App bestimmen Entity-/Node-Identitäten, Scope, Tool, Query, Sortierung, Limits, Evidence, Artifact und Conversation-Commit.
...
- Erfolgreiche semantische Find-/List-Turns verwenden den gemeinsamen Local Intent Execution Kernel, das revalidierte Primary Result, Result-Artefakt, den deterministischen Answer Fallback und die Presentation Firewall. Es entsteht weder eine freie Answer-Provider-Session noch ein zweiter Modellaufruf.
