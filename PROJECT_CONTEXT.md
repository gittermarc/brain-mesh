...
- `BrainMesh/GraphChat/`
  ...
  - `Orchestration/` initialisiert Schema, Provider, request-scoped Tool-Runner, Budget und Evidence-Registry, verwirft Sessions bei Graph-/Scope-Wechsel, erlaubt höchstens eine laufende Generation und validiert Quellen erst nach der finalen Antwort.
