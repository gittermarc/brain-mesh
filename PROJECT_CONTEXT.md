...
> Start Here für neue Entwickler:innen. Stand: GRAPH-CHAT-COMPOSABLE-READ-EXECUTION-1 nach GRAPH-CHAT-COMPOSABLE-READ-PLAN-1, mit kontrollierter providerfreier Ein-/Zwei-Hop-Ausführung für app-kompilierte Entity-, Detailfeld-, Link- und Link-Notiz-Bedingungen, vollständigen Budgets, pfadgebundener Evidence, typisierten Resultsets, sichtbaren Limitquellen und exakter CURRENT-Fortsetzung.
