...
struct GraphTransferViewModelLogicTests {
    ...
    func userFacingMessage_mapsTransferErrorsAndCocoaAccessErrors() {
        ...
        #expect(model.userFacingMessage(for: GraphTransferError.invalidDetailData) == "Die Detaildaten der Importdatei sind nicht eindeutig oder passen nicht zum enthaltenen Graphen. Der Import wurde abgebrochen, damit keine inkonsistenten Daten übernommen werden.")
        ...
        #expect(model.userFacingMessage(for: GraphTransferError.fullBackupImportNotAvailable) == "Full-Backup-Import ist für diese Datei nicht möglich. Prüfe die Hinweise und wähle bei Bedarf eine andere Datei.")
